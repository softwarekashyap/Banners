...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
   ...
   const YOUTUBEAUTOPLAY  = 'banner/general/youtube_autoplay';
   const YOUTUBESOUND  = 'banner/general/youtube_sound';
   const EFFECT  = 'banner/general/effect';
    ...
    {
        return $this->scopeConfig->getValue(self::YOUTUBEAUTOPLAY, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
    
    public function getYouTubeSound()
    {
        return $this->scopeConfig->getValue(self::YOUTUBESOUND, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
