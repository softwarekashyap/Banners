...
class BannersActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    ...
    const URL_PATH_EDIT = 'kashyap_banners/banners/edit';
    protected $urlBuilder;
    const URL_PATH_DETAILS = 'kashyap_banners/banners/details';
    const URL_PATH_DELETE = 'kashyap_banners/banners/delete';
